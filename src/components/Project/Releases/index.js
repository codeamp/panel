            ...
            <Grid container spacing={0}>
              <Grid item xs={10}>
                ...
                <Typography component="p" className={styles.featureAuthor}>
                  by <b> { (this.props.release.user !== null && this.props.release.user.email !== "") ? this.props.release.user.email : "Continuous Deploy" } </b> - { new Date(this.props.release.created).toString() }
                </Typography>
