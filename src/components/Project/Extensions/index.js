...
@graphql(gql`
  mutation CreateExtension ($projectId: String!, $extensionSpecId: String!, $environmentVariables: [ExtensionEnvironmentVariableInput!]!, $config: Json!, $environmentId: String!) {
...
@graphql(gql`
  mutation UpdateExtension ($id: String, $projectId: String!, $extensionSpecId: String!, $environmentVariables: [ExtensionEnvironmentVariableInput!]!, $config: Json!, $environmentId: String!) {
...
@graphql(gql`
  mutation DeleteExtension ($id: String, $projectId: String!, $extensionSpecId: String!, $environmentVariables: [ExtensionEnvironmentVariableInput!]!, $config: Json!, $environmentId: String!) {
...
export default class Extensions extends React.Component {
  ...
  renderConfig(extensionSpec){
    var config = extensionSpec.config.config
